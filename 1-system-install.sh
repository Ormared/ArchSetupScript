...
PKGS=(
	...
	'xfce4' # XFCE Desktop
	'xfce4-goodies' # All the XFCE extras
...
if ! source /root/ArchSetupScript/setup.conf; then
...
echo "username=${username,,}" >> ${HOME}/ArchSetupScript/setup.conf

    #Set Password
    read -p "Please enter password:" password
echo "password=${password,,}" >> ${HOME}/ArchSetupScript/setup.conf
    ...
    echo "nameofmachine=${nameofmachine,,}" >> ${HOME}/ArchSetupScript/setup.conf
fi
echo -ne "
-------------------------------------------------------------------------
                    Adding User
...
# use chpasswd to enter $username:$password
	...
	cp -R /root/ArchSetupScript /home/$USERNAME/
    chown -R $USERNAME: /home/$USERNAME/ArchSetupScript
